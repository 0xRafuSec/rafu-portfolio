  ...
  const education = [
    {
      ...
      fyp: {
        ...
        link: 'https://github.com/0xRafuSec/Multi-Sensor-Intrusion-Detection-IOT',
      },
    },
  ]
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-6">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide font-mono">
                        Key Courses
                      </h4>
                    </div>
                    <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                      {edu.courses.map((course, courseIndex) => (
                        ...
                        >
                          <span className="text-cyber-green-dark dark:text-cyber-green mt-1.5 group-hover/item:scale-125 transition-transform duration-200">
                            ▸
                          </span>
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-white/5">
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 font-mono leading-relaxed">{edu.fyp.description}</p>
                    </a>
                  </div>
                </div>
              </div>
